 ...
 * Project:      SPI (SSP used for SPI) Driver for Eigencomm EC618
 * --------------------------------------------------------------------------
...
if (spi->pins.pin_ssn->pinNum != 0xFF){
